...
export default function HowItWorks() {
  ...
  const socialIcons = {
    google: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    github: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    metamask: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none">
        <path d="M19.2 3.54 13.1 8.1l1.3-2.93 4.8-1.62Z" fill="#E17726" />
        <path d="m4.8 3.54 6.05 4.6-1.24-2.98L4.8 3.54ZM16.83 15.9l-1.78 3.08 3.8 1.18 1.07-4.22-3.1-.05Zm-12.74.04 1.07 4.22 3.8-1.18-1.79-3.09-3.08.05Z" fill="#E27625" />
      </svg>
  };
  return <div className="space-y-8 md:space-y-12 max-w-4xl mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        {steps.map(step => <div key={step.number} className="flex flex-col gap-4">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <h3 className="text-base font-semibold md:text-lg">Signup{step.title}</h3>
            </div>
            ...
            <div className="w-full max-w-56 pt-4 md:px-2 flex flex-col gap-3">
              ...
              {step.number === 1 && <div className="flex flex-row gap-2 max-w-56">
              ...
              {step.number === 2 && <div className="space-y-2">
