  ...
  const steps = [
    {
      ...
      icon: User,
      mockups: [
        { icon: User, description: 'User profile setup' },
        { type: 'social', icons: ['google', 'github', 'metamask'], description: 'Social login options' },
        { icon: Mail, description: 'Email verification' },
      ]
    },
    {
      number: 2,
      ...
      icon: CreditCard,
      mockups: [
        { icon: CreditCard, description: 'Credit card setup' },
    ...
    },
    {
      ...
      icon: Key,
      mockups: [
        { icon: Key, description: 'API key generation' },
        { type: 'api-key', key: 'OPENROUTER_API_KEY', value: '••••••••••••••••' }
      ]
    }
  ];
